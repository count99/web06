...
$query_Recordset1 = "SELECT * FROM images where m_del=0";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
	...
	for($i=0; $i<count($_POST['hiddenField']);$i++){	
  	@$updateSQL = sprintf("UPDATE images SET m_view=%s, m_del=%s WHERE m_seq=%s",
...
<p class="t cent botli">管理者帳號管理</p>
        <form name="form" method="POST" action="<?php echo $editFormAction; ?>">
          <table width="544" border="0">
            ...
            <tr>
              ...
              <img src="<?php echo $row_Recordset1['m_img'];?>"  width="120px"/></td>
              ...
              <td align="center"><button formmethod="post" name="m_seq" formaction="admin.php?do=admin&redo=img_change" onclick="self.location.href='admin.php?do=admin&redo=img_change'" value="<?php echo $row_Recordset1['m_seq'];?>">更換動畫</button></td>
            </tr>
            <?php
            $ind++; 
     ...
     <tbody><tr>
      <td width="200px"><input type="button" onclick="self.location.href='admin.php?do=admin&redo=img_create'" value="新增動畫圖片"></td><td class="cent"><input type="submit" value="修改確定"><input type="reset" value="重置"></td>
     </tr>
    </tbody></table>
