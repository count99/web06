...
if (isset($_POST['acc'])) {
  ...
  $LoginRS__query=sprintf("SELECT m_id, m_password FROM member WHERE m_id=%s AND m_password=%s AND m_delete!=1",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $db06) or die(mysql_error());
